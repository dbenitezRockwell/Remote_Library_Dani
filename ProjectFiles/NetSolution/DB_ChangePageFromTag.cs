...
//20240725 Adaptacion del codigo "https://github.com/FactoryTalk-Optix/Optix_Sample_ChangeScreenFromTag.git"  Ya que usa variables que
//no se usan y publica un metodo que no hace falta volver a llamar...
// Lo simplifico y parece que funciona.

public class DB_ChangePageFromTag : BaseNetLogic
{
    ...
    //[ExportMethod]  //No veo para que sirve publicar esta funcion si solo se ejecuta en el START 
    //A no ser que en RunTime se creen nuevos displays o se les cambie el numero...
    public void CreatePagesList()
    {
        ...
        Log.Warning("CreatePagesList", "Pantallas indexadas y listas para llamarlas!!");
