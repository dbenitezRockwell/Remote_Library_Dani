...
public class Cop_INT2INT : BaseNetLogic
{
    ...
    public void test()
    {
        try
        {
            ...
            if (temp_Enable == true)
            {
                ...
                var PLC_I = Project.Current.GetVariable("CommDrivers/EtherNet_IP/PLC/Tags/Program:Test_Datos/Datos_INT_In"); //Daniel_test_Escritura_Vectores/CommDrivers/EtherNet_IP/PLC/Tags/Program:Test_Datos/Datos_INT_In
                var PLC_O = Project.Current.GetVariable("CommDrivers/EtherNet_IP/PLC/Tags/Program:Test_Datos/Datos_INT_Out");
                ...
                Log.Info("Cop_INT2INT", "OK; Time = " + Resultado);
            }
        }
        catch (System.Exception)
        {
            Log.Error("Cop_INT2INT", "!!Error!!");
        }
